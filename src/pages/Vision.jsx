        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-6 w-full">
          <div className="max-w-3xl">
            ...
            <h2 className="text-6xl lg:text-8xl font-display font-extrabold text-white leading-tight mb-8">
              Nuestra <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Misión y Visión</span>
            </h2>
            <p className="text-xl text-white/80 leading-relaxed mb-10 max-w-xl">
              Guiamos el futuro educativo de la región con excelencia, transparencia y un compromiso inquebrantable con nuestra comunidad.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="relative group p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl transition-all hover:-translate-y-2 overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <h3 className="text-4xl font-display font-bold dark:text-white">Nuestra Misión</h3>
              </div>
              <p className="text-xl leading-loose text-slate-600 dark:text-slate-400">
                "Promover el desarrollo de un <span className="text-primary font-bold">servicio educativo de calidad</span>, con equidad, valores y respeto por la interculturalidad de los pueblos de nuestra jurisdicción, en concordancia con la política regional y nacional."
              </p>
              <div className="mt-12 pt-8 border-t border-slate-100 dark:border-slate-800 flex items-center gap-3 text-slate-400">
                ...
                <span className="text-sm font-medium italic">Compromiso que nos define cada día</span>
              </div>
            </div>
            ...
            <div className="relative group p-12 rounded-3xl bg-slate-900 text-white shadow-2xl transition-all hover:-translate-y-2 overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-4xl font-display font-bold">Nuestra Visión</h3>
                </div>
                <p className="text-xl leading-loose text-white/90">
                  "Ser reconocidos al 2030 como una <span className="text-blue-300 font-bold">institución líder en gestión educativa</span>, que garantiza aprendizajes de calidad y forma ciudadanos competentes, éticos y comprometidos con el desarrollo sostenible de Huacaybamba."
                </p>
                <div className="mt-12 pt-8 border-t border-white/10 flex items-center gap-3 text-white/60">
                  ...
                  <span className="text-sm font-medium italic">Proyección hacia la excelencia regional</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-slate-100 dark:bg-slate-900/50 py-32 px-6">
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-20 text-center max-w-2xl mx-auto">
            <span className="text-primary font-bold text-sm tracking-widest uppercase mb-4 block">Ejes de Gestión</span>
            <h2 className="text-5xl font-display font-extrabold mb-6 dark:text-white">Objetivos Institucionales</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 p-10 rounded-[2.5rem] bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl transition-all flex flex-col justify-between group">
              <div>
                <span className="text-8xl font-display font-black text-slate-100 dark:text-slate-700/50 group-hover:text-primary/10 transition-colors">01</span>
                <h4 className="text-2xl font-bold mt-4 mb-4 dark:text-white">Mejora Continua de la Calidad</h4>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                  Implementar estrategias pedagógicas innovadoras para elevar los logros de aprendizaje en todas las instituciones.
                </p>
              </div>
              <div className="mt-8">
                <span className="material-symbols-rounded text-primary text-4xl">trending_up</span>
              </div>
            </div>
            ...
            <div className="p-10 rounded-[2.5rem] bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl transition-all group">
              <span className="text-6xl font-display font-black text-slate-100 dark:text-slate-700/50 group-hover:text-primary/10 transition-colors">02</span>
              <h4 className="text-xl font-bold mt-4 mb-4 dark:text-white">Inclusión y Equidad</h4>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                Garantizar el acceso y culminación de la educación básica con atención especial a poblaciones vulnerables.
              </p>
            </div>

            {/* Objetivo 3 */}
            <div className="p-10 rounded-[2.5rem] bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl transition-all group">
              <span className="text-6xl font-display font-black text-slate-100 dark:text-slate-700/50 group-hover:text-primary/10 transition-colors">03</span>
              <h4 className="text-xl font-bold mt-4 mb-4 dark:text-white">Gestión Moderna</h4>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                Modernizar procesos administrativos mediante tecnología y promover la transparencia total.
              </p>
            </div>
            ...
            <div className="lg:col-span-2 lg:row-span-1 p-10 rounded-[2.5rem] bg-primary text-white shadow-2xl shadow-primary/20 flex items-center gap-8 relative overflow-hidden group">
              <div className="relative z-10 flex-1">
                <span className="text-6xl font-display font-black text-white/20">04</span>
                <h4 className="text-2xl font-bold mt-2 mb-4">Fortalecimiento de Infraestructura</h4>
                <p className="text-white/80 leading-relaxed">
                  Mejorar y ampliar espacios seguros, accesibles y adecuados para procesos pedagógicos de calidad.
                </p>
              </div>
              <div className="relative z-10 hidden md:block">
                <span className="material-symbols-rounded text-[100px] text-white/20 group-hover:scale-110 transition-transform duration-500">domain</span>
              </div>
            ...
            {/* Objetivo 5 */}
            <div className="p-10 rounded-[2.5rem] bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl transition-all group">
              <span className="text-6xl font-display font-black text-slate-100 dark:text-slate-700/50 group-hover:text-primary/10 transition-colors">05</span>
              <h4 className="text-xl font-bold mt-4 mb-4 dark:text-white">Articulación</h4>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                Promover alianzas con instituciones públicas y privadas para potenciar el desarrollo territorial.
              </p>
            </div>

            {/* Objetivo 6 */}
            <div className="p-10 rounded-[2.5rem] bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl transition-all group">
              <span className="text-6xl font-display font-black text-slate-100 dark:text-slate-700/50 group-hover:text-primary/10 transition-colors">06</span>
              <h4 className="text-xl font-bold mt-4 mb-4 dark:text-white">Bienestar Docente</h4>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                Implementar programas de acompañamiento y reconocimiento para los profesionales de la educación.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-white dark:bg-background-dark">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h3 className="text-3xl md:text-5xl font-display font-light leading-snug dark:text-white italic">
            "Trabajamos con una misión clara y una visión que proyecta el desarrollo educativo de{' '}
