...
const Home = () => {
  ...
  return (
    <div>
      ...
      <section className="max-w-[1600px] mx-auto px-6 py-20 relative z-10 -mt-20">
        <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-[32px] p-10 shadow-2xl border border-white/20 dark:border-slate-700/50">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-extrabold mb-2 dark:text-white">Aplicativos de Interés</h2>
            <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">Accede rápidamente a los servicios y plataformas digitales más utilizados.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            <div className="group bg-blue-50 dark:bg-blue-900/20 p-6 rounded-2xl border border-blue-100 dark:border-blue-800/50 hover:shadow-xl hover:shadow-blue-200/50 dark:hover:shadow-none transition-all duration-300 hover:-translate-y-2 cursor-pointer text-center">
              <div className="w-14 h-14 bg-blue-600 text-white rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-blue-500/30">
                <span className="material-symbols-rounded text-3xl">folder_shared</span>
              </div>
              <h3 className="font-bold text-lg mb-1 dark:text-white">Expedientes</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">Seguimiento en línea</p>
            </div>
            <div className="group bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-2xl border border-emerald-100 dark:border-emerald-800/50 hover:shadow-xl hover:shadow-emerald-200/50 dark:hover:shadow-none transition-all duration-300 hover:-translate-y-2 cursor-pointer text-center">
              ...
              <h3 className="font-bold text-lg mb-1 dark:text-white">Convocatorias</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">Procesos vigentes</p>
            </div>
            ...
            <div className="group bg-amber-50 dark:bg-amber-900/20 p-6 rounded-2xl border border-amber-100 dark:border-amber-800/50 hover:shadow-xl hover:shadow-amber-200/50 dark:hover:shadow-none transition-all duration-300 hover:-translate-y-2 cursor-pointer text-center">
              ...
              <h3 className="font-bold text-lg mb-1 dark:text-white">Documentos</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">Normativas oficiales</p>
            </div>
            <div className="group bg-rose-50 dark:bg-rose-900/20 p-6 rounded-2xl border border-rose-100 dark:border-rose-800/50 hover:shadow-xl hover:shadow-rose-200/50 dark:hover:shadow-none transition-all duration-300 hover:-translate-y-2 cursor-pointer text-center">
              <div className="w-14 h-14 bg-rose-600 text-white rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-rose-500/30">
                <span className="material-symbols-rounded text-3xl">handshake</span>
              </div>
              <h3 className="font-bold text-lg mb-1 dark:text-white">Convivencia</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">Reporte SISEVE</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative h-[650px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-6 h-full flex items-center">
          <div className="w-full lg:w-2/3">
            <h2 className="text-5xl font-extrabold text-white mb-8 tracking-tight">Acceso a Servicios y Transparencia</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="glass-card p-8 rounded-2xl text-white group cursor-pointer hover:bg-white/30 transition-all">
                <div className="flex items-center gap-4 mb-4">
                  <span className="material-symbols-rounded text-3xl bg-white/20 p-3 rounded-xl">visibility</span>
                  <h3 className="font-bold text-2xl">Portal de Transparencia</h3>
                </div>
                <p className="text-white/80 mb-6">Información pública y rendición de cuentas según normativa vigente.</p>
                <a className="inline-flex items-center gap-2 font-bold group-hover:gap-4 transition-all underline decoration-2 underline-offset-4" href="#">
                  Acceder al portal <span className="material-symbols-rounded">arrow_forward</span>
                </a>
              </div>
              <div className="glass-card p-8 rounded-2xl text-white group cursor-pointer hover:bg-white/30 transition-all">
                <div className="flex items-center gap-4 mb-4">
                  <span className="material-symbols-rounded text-3xl bg-white/20 p-3 rounded-xl">warning</span>
                  <h3 className="font-bold text-2xl">Denuncias Anónimas</h3>
                </div>
                <p className="text-white/80 mb-6">Canal seguro para reportar irregularidades o actos de corrupción.</p>
                <a className="inline-flex items-center gap-2 font-bold group-hover:gap-4 transition-all underline decoration-2 underline-offset-4" href="#">
                  Reportar ahora <span className="material-symbols-rounded">arrow_forward</span>
                </a>
              </div>
              <div className="glass-card p-8 rounded-2xl text-white group cursor-pointer hover:bg-white/30 transition-all">
                <div className="flex items-center gap-4 mb-4">
                  <span className="material-symbols-rounded text-3xl bg-white/20 p-3 rounded-xl">request_quote</span>
                  <h3 className="font-bold text-2xl">Información Pública</h3>
                </div>
                <p className="text-white/80 mb-6">Solicitudes formales de acceso a la información institucional.</p>
                <a className="inline-flex items-center gap-2 font-bold group-hover:gap-4 transition-all underline decoration-2 underline-offset-4" href="#">
                  Solicitar <span className="material-symbols-rounded">arrow_forward</span>
                </a>
              </div>
              <div className="glass-card p-8 rounded-2xl text-white group cursor-pointer hover:bg-white/30 transition-all">
                <div className="flex items-center gap-4 mb-4">
                  <span className="material-symbols-rounded text-3xl bg-white/20 p-3 rounded-xl">forum</span>
                  <h3 className="font-bold text-2xl">Participación Ciudadana</h3>
                </div>
                <p className="text-white/80 mb-6">Espacios de diálogo, consulta y vigilancia ciudadana activa.</p>
                <a className="inline-flex items-center gap-2 font-bold group-hover:gap-4 transition-all underline decoration-2 underline-offset-4" href="#">
                  Participar <span className="material-symbols-rounded">arrow_forward</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-[1600px] mx-auto px-6 py-24">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extrabold mb-4 dark:text-white">Trámites y Servicios</h2>
          <p className="text-slate-500 dark:text-slate-400">Simplificamos tu gestión administrativa con acceso directo a todos nuestros servicios.</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 max-w-[1200px] mx-auto">
          {([
            ...
            <a key={index} className="group bg-white dark:bg-slate-800 rounded-xl p-8 border border-blue-500/20 hover:border-blue-500 shadow-sm hover:shadow-xl hover:shadow-blue-500/10 transition-all flex flex-col items-center text-center" href="#">
              <div className="mb-6 transform group-hover:scale-110 transition-transform duration-300">
                <span className="material-symbols-rounded text-5xl text-blue-600">{item.icon}</span>
              </div>
              <h3 className="text-lg font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wide leading-tight">{item.title}</h3>
            </a>
          ))}
        </div>
      </section>
      ...
      <section className="bg-primary/5 dark:bg-slate-900/50 py-24">
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-extrabold mb-4 dark:text-white">Gestión Institucional</h2>
            <p className="text-slate-500 dark:text-slate-400">Comprometidos con el desarrollo educativo de Huacaybamba.</p>
          </div>
          <div className="bg-white dark:bg-slate-800 rounded-[40px] shadow-2xl overflow-hidden flex flex-col lg:flex-row items-center border border-slate-100 dark:border-slate-700">
            <div className="lg:w-1/2 p-12 lg:p-20">
              ...
              <h3 className="text-4xl font-extrabold mb-6 dark:text-white">Mensaje del Director de la UGEL Huacaybamba</h3>
              <div className="space-y-4 text-slate-600 dark:text-slate-300 leading-relaxed text-lg italic">
                <p>"Es un honor dirigirme a ustedes para liderar esta gestión. Nuestro compromiso es transformar la educación en nuestra provincia, fomentando un entorno de inclusión, innovación y excelencia académica para cada estudiante."</p>
                <p>"Trabajamos incansablemente para asegurar que nuestras instituciones sean espacios de crecimiento real, donde el talento de nuestros niños y jóvenes florezca sin límites."</p>
              </div>
              <div className="mt-12 flex items-center gap-6">
                <div>
                  <p className="font-extrabold text-2xl dark:text-white">Dr. Juan Carlos Pérez</p>
                  <p className="text-primary font-bold tracking-wide">DIRECTOR - UGEL HUACAYBAMBA</p>
                </div>
                <div className="flex gap-2">
                  <a className="w-10 h-10 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all" href="#">
                    <span className="material-symbols-rounded text-lg">facebook</span>
                  </a>
                  <a className="w-10 h-10 bg-sky-100 text-sky-600 rounded-full flex items-center justify-center hover:bg-sky-600 hover:text-white transition-all" href="#">
                    <span className="material-symbols-rounded text-lg">public</span>
                  </a>
                  <a className="w-10 h-10 bg-red-100 text-red-600 rounded-full flex items-center justify-center hover:bg-red-600 hover:text-white transition-all" href="#">
      ...
      <section className="max-w-[1600px] mx-auto px-6 py-24">
        <div className="flex justify-between items-end mb-16">
          <div>
            <p className="text-primary font-bold uppercase tracking-widest text-sm mb-2">Nuestro Equipo</p>
            <h2 className="text-4xl font-extrabold dark:text-white">Directorio de Funcionarios</h2>
          </div>
          <a className="bg-slate-100 dark:bg-slate-800 px-6 py-3 rounded-full font-bold text-sm hover:bg-primary hover:text-white transition-all" href="#">
          ...
          {([
            {
              ...
              image: "https://lh3.googleusercontent.com/aida-public/AB6AXuD9epMDik9z9bVB2FMctS453SzVWubHW6xnlVrAuigz-PnaAWDrf8snCbYrxQr7duuKfIzqaGEUmSf0crmf2ui4JD2AxuO2rhDQc9i4w3Men9UvB8UsYDqZOAuqYxhaTnPFa8Faq5Uk5pdOosC6PmL-ZAhHVsW6vhUoQylkW6qpdaQUqmkntoLkO-Bq7oEv4zXRTuHfaeg5Mpm_ijZy5AXw5h7sPZjDMVR53kTOqOxxAYUu0YZBKUtmNYrNWeWdrVycadoXyMSvopI"
            },
            {
              ...
              image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCpghnaJazwh3qw3L2a9svyHe0dev1k2f32ayrbx6hFTe_KrGntW9cL-8ypAtN0S79BNeW0DMgjZfopzMZrwVAxvHUmkaLBXEXfsNEJfQGlc7jdt6j-VTsO7dCouS30bo4tyQ2pfOnwdJupoYcvj3Ra9qt-97CwlUZfQDNu1uAVH0cmBAX77lUUNufLymK61KaV0wyVDg2EpnBwpVWnqY6L6BMIglLKfHEWhLXPhQo2I60PXeR-MPiCXzMmJUeP3woXcKvgJ_C-L3A"
            },
            {
              ...
              image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBH5eg5eaht_--V2vnh-zUjaxIe7tpgfgNfC69A4wjfXYF1V2OnF7xkyRiarJ1rNtIgLEcGa0zm5uaPUPNofz_p9u_o-k8SLvdAOAiE9ahNC1yCeBDEXop1MHwxl6VAGnx0a6SdMoTZp1Xpg422WP2nDD8Q366P_8dlI-Lg5IALNGs2hjP-aCymB82ThM17DYh9f1yD1UJqK0c3un5ROk5WCK-IYXfUnkd6tjUW2riqMt80DuTMf1D7vaIVZXojeEVB0KYKWptBIgw"
            }
          ]).map((person, index) => (
            <div key={index} className="bg-white dark:bg-slate-800 rounded-3xl p-6 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-xl transition-all group">
              ...
              <h4 className="font-bold text-2xl mb-1 dark:text-white">{person.name}</h4>
              <p className="text-primary font-bold text-sm mb-4">{person.role}</p>
              <div className="flex flex-col gap-2 text-sm text-slate-500 dark:text-slate-400">
                <div className="flex items-center gap-2">
                  <span className="material-symbols-rounded text-lg">alternate_email</span> {person.email}
                </div>
                <div className="flex items-center gap-2">
                  <span className="material-symbols-rounded text-lg">location_on</span> {person.location}
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="bg-secondary py-20">
        <div className="max-w-[1600px] mx-auto px-6 grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
          {([
            { icon: "domain", number: "156", label: "Instituciones Educativas" },
      ...
      <section className="max-w-[1600px] mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {([
            {
              image: "https://lh3.googleusercontent.com/aida-public/AB6AXuDi2HrawoxpNYFOinTyn4-3JtrAOUFr4ZHlUDtCIrJcvx5HnKpbWtyIbuonjlZ1DjTUQpQvP1U55rp-OKMptleicjNIimELsvkkd97PAxRSEHScgAdWAMqL5Cu5L5oxJTHuEndVHyAMWStwBl5VdpN3P6a94pheJKG3ygL1yzTo7U-fcsMQHfSbgkMSx5hxf2jioPcT51QzWbbbo0iEstG8fr0dXdwJOnfORJGKf0sJih4ZL4E4TQ4qxiMwiW70Ja57YjhucacFN4I",
              badge: "Nuevo",
              badgeColor: "orange",
              date: "15 Ene 2024",
              author: "UGEL Prensa",
              title: "Protocolos de Inicio de Año Escolar 2025",
              excerpt: "Se establecen los nuevos lineamientos para garantizar un retorno a clases seguro y eficiente en todas las instituciones de la jurisdicción..."
            },
            {
              image: "https://lh3.googleusercontent.com/aida-public/AB6AXuByHzw-nSry-1TJvlt-579SfhrH-UBvWlZ9owvLroFGzaVP08hClNQ4a2EIxXmmAOxJGKXTsGMcahWmOHBTGHoFkGLoe5sc6JG3DvOY7OecidkBqUZ7ySQfAo1j9EDh6bonbcVqlupvbN48bvv7QeLRqSTmHdT5lfnVA7QEK61DlqLyLLFOD4SGp_ZEg73ImxGaniDq0wcMVCfrTG6xL8yBaba5y5zSKyQs2ijDkTMFSRPRveWhdMjp6cW5awJgQdgv9R1L3We_Rfs",
              badge: "Capacitación",
              badgeColor: "blue",
              date: "12 Ene 2024",
              author: "Gestión Pedagógica",
              title: "Taller de Innovación para Docentes Rurales",
              excerpt: "Fortalecimiento de capacidades en metodologías activas y herramientas digitales adaptadas al contexto rural de nuestra provincia..."
            },
            {
              image: "https://lh3.googleusercontent.com/aida-public/AB6AXuA3yf-LMC5m6Uq79cjf1FQMAivxIeNQ7uY_qtwOA9IHcZcsPR1woENYjF9mA79NB9dYssyf-apBnrpI3c4rZZedtmAWr7hEHpDCJFeBKnhH36T09IfPsd_Fx99S6wZL6kOFEwL8UaaMA1n4JjURDvBtlqXLJSTDavVvUGk2zEa_fC8NKVdYyO-JQtpevDVVj7vzmdxOejECvOuia19ds8a7Cn2Pshtukt7lQ2ezZqGtlLegdPE_fxwuvpxF_ZeUI5OMGgevBfds2Gk",
              badge: "Infraestructura",
              badgeColor: "emerald",
              date: "10 Ene 2024",
              author: "Infraestructura",
              title: "Mejoramiento de II.EE. en Huacaybamba",
              excerpt: "Supervisión de obras de mantenimiento preventivo en 25 instituciones educativas para asegurar ambientes óptimos el próximo año..."
            }
          ]).map((news, index) => (
            <article key={index} className="group bg-white dark:bg-slate-800 rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all border border-slate-100 dark:border-slate-700">
              <div className="h-64 relative overflow-hidden">
                <img 
                  ...
                  src={news.image}
                />
                <span className={`absolute top-4 left-4 bg-${news.badgeColor}-500 text-white px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest`}>
                  {news.badge}
                </span>
              </div>
              <div className="p-8">
                <div className="flex items-center gap-4 text-slate-400 text-sm mb-4">
                  <span className="flex items-center gap-1">
                    <span className="material-symbols-rounded text-base">calendar_today</span> {news.date}
                  </span>
                  <span className="flex items-center gap-1">
                    <span className="material-symbols-rounded text-base">person</span> {news.author}
                  </span>
                </div>
                <h3 className="font-extrabold text-2xl mb-4 group-hover:text-primary transition-colors dark:text-white">{news.title}</h3>
                <p className="text-slate-500 dark:text-slate-400 mb-8 line-clamp-3">{news.excerpt}</p>
                <a className="inline-flex items-center gap-2 font-extrabold text-primary group-hover:gap-4 transition-all" href="#">
                  Leer más <span className="material-symbols-rounded">arrow_right_alt</span>
                </a>
              </div>
            </article>
          ))}
      ...
      <section className="bg-slate-50 dark:bg-slate-900/30 py-24">
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-4xl font-extrabold mb-4 dark:text-white">Convocatorias Vigentes</h2>
              <p className="text-slate-500 dark:text-slate-400">Encuentra oportunidades de desarrollo profesional en nuestra institución.</p>
            </div>
            <a className="text-primary font-bold flex items-center gap-2 hover:gap-4 transition-all" href="#">
              Ver todas las convocatorias <span className="material-symbols-rounded">trending_flat</span>
            </a>
          </div>
            ...
            {([
              {
                ...
                description: "Proceso de contratación de docentes para plazas vacantes en instituciones de educación inicial de la provincia de Huacaybamba.",
              ...
              },
              {
                ...
                description: "Selección de cargos directivos bajo la modalidad de encargatura para el periodo lectivo 2025 en instituciones de educación básica.",
                published: "hoy",
                files: "5 Archivos PDF"
              }
            ]).map((conv, index) => (
              <div key={index} className="bg-white dark:bg-slate-800 p-8 rounded-3xl border border-slate-100 dark:border-slate-700 flex flex-col md:flex-row gap-8 items-start hover:shadow-xl transition-all group">
                <div className="flex-1">
                  ...
                  <h3 className="text-2xl font-extrabold mb-4 group-hover:text-primary transition-colors dark:text-white">{conv.title}</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm mb-6 leading-relaxed">{conv.description}</p>
                  <div className="flex items-center gap-6 text-xs font-bold text-slate-400">
                    <span className="flex items-center gap-1">
                      <span className="material-symbols-rounded text-sm">schedule</span> Publicado: {conv.published}
                    </span>
                    <span className="flex items-center gap-1">
                      <span className="material-symbols-rounded text-sm">description</span> {conv.files}
                    </span>
                  </div>
                </div>
