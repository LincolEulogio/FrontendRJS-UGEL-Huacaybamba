...
const InstitutionalManagement = () => {
  const objectives = [
    {
      ...
      description:
        "Diseñar e implementar planes institucionales alineados con las políticas educativas del sector.",
      icon: "target",
    },
    {
      title: "Gestión de Calidad",
      description:
        "Monitoreo y evaluación de procesos para garantizar estándares de calidad educativa.",
      icon: "verified",
    },
    {
      title: "Desarrollo Institucional",
      description:
        "Fortalecer las capacidades organizacionales y promover la mejora continua.",
      icon: "trending_up",
    },
  ];
  ...
  const functions = [
    {
      ...
      description:
        "Elaboración y actualización de MOF, ROF, PAT y otros instrumentos",
    },
    {
      icon: "analytics",
  ...
  const team = [
    ...
    },
    {
      id: "016",
      name: "Miguel Ángel",
      role: "Especialista en Planificación",
      code: "448-03-01-2",
      image:
      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white">
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto">
            Fortalecemos la gestión institucional mediante planificación
            estratégica y mejora continua de procesos
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {objectives.map((obj, index) => (
            <div
              key={index}
              className="bg-white rounded-[2rem] p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-purple-100"
            >
      ...
      <section className="container mx-auto py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {functions.map((func, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-white to-purple-50 rounded-[24px] p-6 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 border border-purple-100"
            >
              <span className="material-symbols-rounded text-purple-600 text-4xl block mb-4">
                {func.icon}
              </span>
      ...
      <section className="container mx-auto py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((member) => (
            <div
              key={member.id}
              className="group bg-white rounded-[24px] overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-3 transition-all duration-300"
            >
      ...
      <section className="container mx-auto py-20">
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-[2rem] p-12 text-white text-center shadow-2xl">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
            Trabajamos día a día para fortalecer nuestra institución y brindar
