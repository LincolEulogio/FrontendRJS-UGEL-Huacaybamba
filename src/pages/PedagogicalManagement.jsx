...
const PedagogicalManagement = () => {
  ...
  const functions = [
    {
      icon: "gavel",
      title: "Política y Normatividad",
      description:
        "Monitorear y orientar la aplicación de la política y normatividad educativa nacional y regional.",
    },
    {
      icon: "auto_awesome",
      title: "Mejora de la Calidad",
      description:
        "Implementar estrategias alternativas para mejorar la calidad de los servicios educativos.",
    },
    {
      icon: "volunteer_activism",
      title: "Bienestar Social",
      description:
        "Desarrollar programas de prevención, atención integral y bienestar social para los estudiantes.",
    },
    {
      icon: "menu_book",
      title: "Alfabetización",
      description:
        "Promover y ejecutar estrategias efectivas de alfabetización en colaboración institucional.",
    },
    {
      icon: "insights",
      title: "Innovación",
      description:
        "Apoyar y participar en programas de investigación e innovación pedagógica y evaluación.",
    },
  ];
  ...
  const team = [
    {
      ...
      count: "01",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDwY5uHI6jUidiJ0QE7d-N9MN2Es31iON-kKXiHiR_QslYeM6GWLnYzpKr9aXzG4i4xbSvSvoW-vKRp2tzJP-ztzbWHJP7qxwNq1-gEgE5hw_KPUD60v3hwq1W9Q17-oLk_C-VjB0Q-5sxvmKzrbKRIg_5BTMtZ1KVL7owUzc67AayrtEdmMjcVNsQltBh3gxodD2AGrwKTWfVWb8OPAitYdp7FpGx5XKsdCvWkYPg8kc8URUs5zRd4yI2VwxHQ8Ro4SVOSPrD2mPM",
      highlighted: true,
    },
    {
      code: "Cód. 448-02-01-7",
      ...
      count: "02",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCUfpvAJ-Yg45VLmYAOSP1ex_af4tQz-5cIPSHkF7pyvShadj-GQonBWf1mR6vrhS7G7CqWGxG3PFnEubp5odN4F4a8qRlLt9iCCldeoUYrLrSTcLAVEk9M1kH-fBsqScccK22xgSzrlPleiIXDdfvIIntlVK6fvtwtaJZjc1fIK7dTuuCMJNmOQGdMCYWJ2FDOmXHg4Quz9HhOZpoVFZQRilejrFnRZREsbmSr48-PH06aoiM9LhPqgucnEnu9ULLGLrpwHKcWBjc",
    },
    {
      code: "Cód. 448-02-01-7",
    ...
    },
    {
      ...
      count: "02",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuBud7thxw4R4_ZrIhjVQ50iNtOhwGvpNdr4IZTTW1IimW5RfxDh8ereV-8V8LFWqivLX0xZEve6ICeFo5Z8EtYKUdPT6cHnno3N6siyUcyhHV22fLb8uw8YfbQ4D7oW3ZxbN21T25UsDjobdgg2zoJmwbICJ5jxMbQXVohpOAqiZMDXD2I8lb48oe83fVM22LO2J8tZb7-AAc4R4k5O_J1RHlS8ybNLnXFKdZB78rqm_Mtnk79OkXGjtxDISTKLUP-rEb3uYnpPknE",
    },
    {
      code: "Cód. 448-02-01-7",
      ...
      count: "01",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCw3XkMmgzkrN67o4M8P6NUY1wi6MTdxANhKmdAaaGHE4enUVyxhaCGntVtYWllz5SIss9EpZOSBwnwZ80w0XAenTKo1Lx-_jV4nDz3AI9h2610R3sQXoNPhvxe2qFhzl1Qf1c3wPM9ZBPCqGwTQ2X5v2pY4Gyy5GpwKZewtj0LBJNz1-uNmQq6DycLPrM19puPz5iiCd3buA4nNFkw9YnUF6dM10f1-L24uUDsTHGzXqp2bXIwsjWNCUhKs2LtB04PHbTPqYoZnA4",
    },
    {
      ...
      <header className="relative overflow-hidden py-24">
        ...
        <div className="relative z-10 container mx-auto text-center">
          ...
          <p className="mt-6 text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed">
            Fortaleciendo el sistema educativo provincial a través de la
            innovación, el acompañamiento continuo y la excelencia en el
            servicio pedagógico.
          </p>
        </div>
      </header>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {objectives.map((objective, index) => (
              <div
                key={index}
                className="glass p-10 rounded-[24px] shadow-xl hover:shadow-2xl transition-all group"
              >
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {functions.map((func, index) => (
              <div
                key={index}
                className="glass p-8 rounded-[24px] hover:bg-primary hover:text-white transition-all duration-300 group"
              >
            ...
            {team.map((member, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <h4 className="font-extrabold text-xl mb-1 leading-tight">
                    {member.title}
                  </h4>
