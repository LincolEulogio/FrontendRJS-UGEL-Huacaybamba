  ...
  return (
    <div className="bg-background-light dark:bg-background-dark">
      ...
      <section className="relative w-full overflow-hidden">
        ...
        />
        <div className="absolute inset-0 flex flex-col justify-center container mx-auto">
      ...
      <section className="py-24 container mx-auto bg-white dark:bg-background-dark">
