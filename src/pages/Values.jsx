    ...
    <div className="bg-background-light dark:bg-background-dark">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-10 lg:px-40">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-slate-200 text-lg md:text-xl font-medium max-w-xl leading-relaxed">
              Construyendo el futuro de Huacaybamba con integridad, vocación de servicio y excelencia educativa para nuestra comunidad altoandina.
            </p>
            <div className="pt-6">
              <Link 
                to="/mision-vision"
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-slate-600 dark:text-slate-400 mt-4 text-lg">
              Definimos nuestra labor a través de principios que guían a cada maestro y administrativo en la provincia.
            </p>
          </div>
          <div className="hidden md:block">
            <span className="text-primary font-bold flex items-center gap-2">
              Explora nuestra cultura <span className="material-symbols-rounded text-sm">arrow_downward</span>
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-7 group relative overflow-hidden rounded-2xl bg-slate-900 h-[500px]">
            <div 
              ...
              style={{
                backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuD5MproI6nQxjFrwzRtXhnZ5oRiN9VVNz4nHUS64nXwFYcMUlK80YJ31QzzjFTbRqCuK5I7T4fCc7tVioWEaQ3z80MO6yDYFCKbwZAT7oeA2QURP8_zs5X0LrGAYaBYy9X_Jgu5BSDT-XD_dJdrSVAZ_3grgO_MfIcHu7Gidy0Ncy75aDnh7ZXreiW9_922uQdaqESpn-MtApz6J-A4OlsksaikcmVB-dru7dTrNYTLfnppd2vu19CP7Uttq-DQx6ZIAY4BG1UERTg')"
              }}
            />
            <div className="absolute inset-0 bg-gradient-to-t from-secondary via-transparent to-transparent"></div>
            <div className="absolute bottom-0 left-0 p-8 md:p-12 w-full">
              <span className="text-primary font-black text-6xl opacity-20 absolute -top-10 left-8 select-none">01</span>
              <h3 className="text-white text-4xl font-extrabold mb-4">Integridad</h3>
              <p className="text-slate-300 text-lg max-w-md leading-relaxed">
                Actuamos con transparencia y rectitud en cada proceso administrativo, asegurando la confianza de nuestra comunidad educativa.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-5 flex flex-col gap-6">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-primary/10 h-[240px] flex items-center p-8 border border-primary/20">
              <div className="relative z-10">
                ...
                <h3 className="text-secondary dark:text-white text-2xl font-bold mb-2">Responsabilidad</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-snug">
                  Comprometidos con el cumplimiento de nuestras metas pedagógicas y sociales.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-slate-800 h-[240px] flex items-center p-8 shadow-xl shadow-slate-200/50 dark:shadow-none">
              <div className="flex gap-6 items-center">
                ...
                <div>
                  <h3 className="text-secondary dark:text-white text-2xl font-bold mb-2">Equidad</h3>
                  <p className="text-slate-600 dark:text-slate-400 leading-snug">
                    Garantizamos oportunidades para todos los estudiantes, sin distinción de origen.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="relative w-full h-[600px] overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCeBB03mk-hhBc2Z486JDSuGqusRfYC0_wKN99lGjEB0OOm4ufGBqdQ-Tsn6wgFCLS094ZCj0jgJFfejFseT1KFLELZtEXUuq4tY-JMZpn_MWU2MMfNbwFK6Ibk8vIKkNYKXzCObozdZLHI1PHVW5Xzl3f43qI5SnPPRjI4vu3sVRmRHakJS-Ee8uDNy9l-ypEyjaOWs-P_ilKpOFmyaqhM57ZFJS0dH9nYmQRxcaESxPf6OMTXJWmBmNg2KqYEm2FxT_2aoaIj3L0')"
          }}
        />
        ...
        <div className="relative h-full flex items-center justify-center px-6">
          <div className="max-w-4xl text-center bg-white/10 backdrop-blur-xl p-10 md:p-16 rounded-3xl border border-white/20 shadow-2xl">
            ...
            <p className="text-slate-100 text-lg md:text-xl leading-relaxed">
              Valoramos la riqueza cultural de nuestra provincia, fomentando una convivencia armoniosa y el respeto mutuo en cada aula rural. La diversidad es nuestra mayor fortaleza para el aprendizaje colectivo.
            </p>
      ...
      <section className="py-24 px-6 md:px-10 lg:px-40 bg-white dark:bg-background-dark">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                Miramos hacia el futuro integrando nuevas tecnologías y liderando el cambio pedagógico en la región Huánuco.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-secondary dark:text-white">Pensamiento Crítico</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-secondary dark:text-white">Transformación Digital</h4>
                  <p className="text-sm text-slate-600 dark:text-slate-400">
      ...
      <section className="relative bg-secondary py-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-blue-100 text-lg md:text-xl font-medium leading-relaxed">
            Trabajamos día a día para que cada niño y niña de Huacaybamba reciba una educación digna, moderna y con valores firmes.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
            <button className="bg-primary text-white px-10 py-4 rounded-xl font-bold shadow-xl shadow-black/20 hover:bg-blue-600 transition-all">
              Contáctanos ahora
            </button>
            <button className="bg-white/10 backdrop-blur-sm border border-white/20 text-white px-10 py-4 rounded-xl font-bold hover:bg-white/20 transition-all">
