  ...
  return (
    <div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl lg:text-2xl text-slate-600 dark:text-slate-400 font-light leading-relaxed">
                Una creación al servicio de la educación regional. Historia, origen y propósito institucional.
              </p>
            </div>
              ...
              <div className="relative rounded-[2rem] overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/80 to-transparent">
                  <p className="text-white text-sm leading-relaxed italic">
                    "Ubicada en las tierras altas de Huánuco, nuestra institución nace de la necesidad de acercar una educación de calidad a las comunidades rurales."
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-6">
              <h3 className="text-4xl lg:text-5xl font-serif italic text-slate-800 dark:text-slate-100">
                "La geografía también condiciona el acceso a una educación de calidad."
              </h3>
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
                En las tierras altas del departamento de Huánuco, la provincia de Huacaybamba enfrentaba desafíos únicos para garantizar una educación accesible y de calidad para todos sus ciudadanos.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-16">
            <h2 className="text-4xl font-bold mb-4">El Marco Legal - <span className="text-primary">Origen Formal</span></h2>
            <p className="text-slate-600 dark:text-slate-400 max-w-2xl">La creación de nuestra institución se sustenta en un sólido marco normativo que reconoce la autonomía y gestión descentralizada.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="md:col-span-8 relative rounded-3xl overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary/80 via-transparent to-transparent flex flex-col justify-end p-12">
                <span className="text-8xl font-black text-white/40 mb-2">2012</span>
                <h3 className="text-3xl font-bold text-white">Consolidación Legislativa</h3>
              </div>
            </div>
            <div className="md:col-span-4 flex flex-col gap-8">
              <div className="bg-blue-50 dark:bg-slate-800/50 p-8 rounded-3xl border border-blue-100 dark:border-slate-700 flex items-start gap-4 hover:-translate-y-1 transition-transform">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Marco normativo fundamental para el presupuesto público.</p>
                </div>
              </div>
              <div className="bg-blue-50 dark:bg-slate-800/50 p-8 rounded-3xl border border-blue-100 dark:border-slate-700 flex items-start gap-4 hover:-translate-y-1 transition-transform">
                <div className="bg-primary p-3 rounded-xl text-white">
                ...
                <div>
                  <h4 className="font-bold text-lg">Artículo 58 - Ley N.° 28411</h4>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Autorización específica para la creación de unidades ejecutoras.</p>
                </div>
              </div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <h2 className="text-center text-4xl font-bold mb-20">Proceso de Reconocimiento - Hito Institucional</h2>
            ...
            {[
              {
                ...
                image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCQNtghleo4EsrRFS0VCULMHyfW4h1YwaSmM4lU26H0Zq0NpA04r_j6ftrZTkaSvFRR4LfDkorWQ0Hg81fzOCXF-PMVvZBoCQfxKeGpu449q8RThYxxrWMmXrtjNo0hi8U1W0mdnON4QYJlaH8ayAAWkIWyMAvoP-AxJWTGTGSpSyl0L4rdqyo2-WPKkJMKMP4SGopaywqjSfM8J5YnfB5lgvpOyWiNVC-nFKpymq47XYYAlGSFIeMEm_DbC1lOvIIPxhWUer3fNCQ"
              },
              {
                step: "2",
                title: "Oficio N.° 972-2012",
                subtitle: "Documentación formal",
                image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBqO04OfxUxI6dA6-Qy-EAlY7KSerPNuaDA5cmfwX5-V10OBxTANtxEvxfuT9HZtBn47f3W9BMyr3tzxx3lGXrn6uKxAaARL6rhv6-4B1Li-4aKGkopiew0w7_uVngoJGtwRmpkdNxJ9sJ27yhiDuohDNQX-7qXALhPxWgsEI25E2IAmFfslekid9CiAPivO0hnUcXh5cg6B097OtvmGc1ADLOkCvYl11Q6db7fk4T9pMbOA33KR2zBGFs8cAmuj4V00GGJIoNNFKc"
              },
              {
                step: "3",
                title: "Recomendación del MEF",
                subtitle: "Aprobación ministerial",
                image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBh8knefmE6XX1I8ImoBWI133rOPCAPGp6s7S-4XaieXmkotaqQ55UtZMltlGzM4sAzxCpA7IdmkJO37nshHZ_rItaQuM0Ct2KWYKMg-71Luq26H_6M8u5En8PAw2_mIoQpG8HLqls4QaZIZLv6vbYXtwc3A7YmBPDF3zyWij7Jq0m7XQQGkuU63aLktrQzGVLDinFTi5sWnoqBqwp7LcCGGiwv9poX4lpVB-Vx7YsOAqEEY4o0hT1AU9WOfei8Cz20_u2D1RYHTdI"
              },
              {
                step: "4",
                title: "Resolución N.° 2532-2012",
                subtitle: "Creación oficial",
                image: "https://lh3.googleusercontent.com/aida-public/AB6AXuDyhNc0jzK9i7fuKQSmjRdySx4rsOJyci2nRlZQyMuftVEuaeypa0QteRJU8QkWq4lKgJt1LUCvuEuNdd9AZSf5r60tEZ2I-lHAKDQv4fb9LbtU-eFRjQhz9DLk7pofUeOYhiGyZ6T2_uzCELnUUxwp-klpur-LEw_9VD7digGC1dJ6UV_WMyGffDkIR-E8-nTZc-mG2xeaOcO0UqxG0-8A173LpI6Wja6Jrl1ZCRqhw1lTCZSPjyph2nA2XDra1KIzBldIvtmSAaQ"
              }
            ].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="text-white space-y-8">
              <h2 className="text-8xl lg:text-9xl font-black text-white/20 leading-none">2013</h2>
              <h3 className="text-4xl lg:text-5xl font-bold">Inicio de Operaciones - Nueva Etapa</h3>
              <p className="text-xl text-blue-100 leading-relaxed font-light">
                Con el año fiscal 2013 comenzó una nueva era para la educación en Huacaybamba estableciéndose como Unidad Ejecutora 307 del Pliego 448 Gobierno Regional de Huánuco.
              </p>
              <div className="grid sm:grid-cols-2 gap-6 pt-4">
                <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                  <h4 className="font-bold text-lg">Unidad Ejecutora 307</h4>
                  <p className="text-sm text-blue-200 mt-2">Autonomía administrativa y financiera local.</p>
                </div>
                <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                  <h4 className="font-bold text-lg">Pliego 448</h4>
                  <p className="text-sm text-blue-200 mt-2">Dependencia estratégica del GORE Huánuco.</p>
                </div>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-accent p-8 rounded-3xl shadow-xl hidden md:block">
                <span className="material-symbols-rounded text-4xl text-white">handshake</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Significado e Impacto Social</h2>
            ...
            {[
              ...
              <div key={index} className="flex flex-col items-center text-center group">
                ...
                <div className="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mb-4">
                  <span className="material-symbols-rounded text-primary dark:text-blue-400">{item.icon}</span>
                </div>
      ...
      <section className="py-24 bg-white dark:bg-slate-950">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl lg:text-4xl font-serif italic text-slate-800 dark:text-slate-200 max-w-3xl mx-auto leading-relaxed">
            "Hoy, la UGEL Huacaybamba trabaja con compromiso para transformar la educación y fortalecer el futuro de nuestra región."
          </h2>
