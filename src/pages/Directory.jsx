...
const Directory = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      photo:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCKmZc_CGgPkNWlJlHfMg4Vz1AyCcPH1G7y_AAVL7IQ1IRhv46fMoR_jLO_8_HHvX0TPAPLfTGgK3jWoX5_kpl2Y7LZj7Qvf987TTP_OW_9W3kOX_TikDENugRIw7NdY3Q8q9cG2aRsYN2Aj8q_P08yiRNgz2tlpuu0xgvF32XoNS95keNAa0FDd-ym9Owcoj1QnBL4gvc_kk7kGbfn9lEcGt0bRmrnVMNxihVzMYHYIG5NRlZQ51q3wzxU07SnlRaAyEdFB8BcXgM",
      functions: [
        "Acompañamiento pedagógico a docentes de primaria",
    ...
    },
    {
      ...
      photo:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuACcNcskl6M_xtOGU3b6F0lklvJrbaR2-LO0E6V8T2pJW2NPWwwmWIf4euM9VG7EAm1KqyqGAQgtpehbnqs3ZCZuB_RA5M5ypKjzoJIRVJS1-eaooVPqf0fLIn4q5KkCFs7z-YaSJmSjsPDJoz62R9Tn5cgYrCBxZNuqM2ozjU67CWsTaGHYmy1QmgwCxMY1qcPQX2-DY96gLhZv89JtyJVdhERBfyUqVQ4aa21VGAs3GsS_TyLxvk8XK1zW0LSDzKTwj-1b-vSEQU",
      functions: [
        "Acompañamiento a docentes de secundaria",
    ...
    },
    {
      ...
      photo:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuAWVUlNdX-guz7DfDPHYlV3lo9yBbRvjJfL0XuArinaRzxEXuB4oh5VZJfj-I8RWEcY1PdIGVlKZcvX2Ijsp4o1ytXqlOL7G7HsdMosZIm4FDLYh-Zl2NaN5kFqA9X97lK4aeh7xhJHu6OePx2Yv_LKtwyN8XLGaTd5fnDc7TGlQBN-uxwQ6ylQ-r7RS9GdSPx5Op9Xqch9F0kUq00SKLPlQ7ND7TbzNz7xp_sPSAaodHuB3uy7MfHTgYTim0YD0CqkyY2x4HE5PO4",
      functions: [
  ...
  const filteredMembers = teamMembers.filter((member) => {
    const matchesFilter =
      activeFilter === "todas" || member.area === activeFilter;
    const matchesSearch =
    ...
    <div className="bg-background-light dark:bg-background-dark px-6">
      ...
      <header className="pt-20 pb-12 text-center max-w-4xl mx-auto ">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
          Conoce al equipo humano comprometido con la excelencia educativa en la
          provincia de Huacaybamba. Transparencia y servicio a su disposición.
        </p>
      </header>
        ...
        <div className="bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden flex flex-col md:flex-row items-center">
          <div className="flex-1 p-8 md:p-16 space-y-6">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold mt-2 text-slate-900 dark:text-white">
                Mg. Ricardo Alvites Milla
              </h2>
            </div>
            <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed max-w-md">
              Liderando la gestión educativa con enfoque territorial, asegurando
              que cada institución educativa de Huacaybamba reciba el soporte
              necesario para el éxito de nuestros estudiantes.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              >
                ...
                <span className="text-slate-700 dark:text-slate-200 text-sm">
                  r.alvites@ugelhuacaybamba.gob.pe
                </span>
              </a>
              <a
      ...
      <section className="max-w-6xl mx-auto mb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {filteredMembers.map((member) => (
            <div
              key={member.id}
              className="group bg-white dark:bg-slate-800/40 rounded-[2rem] border border-slate-200 dark:border-slate-800 p-1 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 overflow-hidden"
            >
              <div
                className={`h-28 bg-gradient-to-br ${member.area === "pedagogica" ? "from-blue-50 to-indigo-100 dark:from-slate-800 dark:to-slate-700" : "from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700"} rounded-t-[1.8rem]`}
              ></div>
