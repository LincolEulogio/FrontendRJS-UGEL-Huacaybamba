...
const About = () => {
  return (
    <div>
      ...
      <header className="relative h-[600px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-8 w-full">
          <div className="max-w-2xl glass-card p-10 rounded-2xl bg-white/10 text-white">
            <h1 className="text-6xl font-extrabold mb-6 leading-tight">UGEL Huacaybamba</h1>
            <p className="text-xl opacity-90 mb-10 leading-relaxed font-light">
              Comprometidos con la excelencia educativa y el desarrollo integral de nuestra comunidad estudiantil en Huánuco.
            </p>
            <div className="flex gap-4">
              <button className="bg-primary hover:bg-blue-700 text-white px-8 py-4 rounded-full font-bold transition-all shadow-lg flex items-center gap-2 group">
                Conoce Más <span className="material-symbols-rounded group-hover:translate-x-1 transition-transform">arrow_forward</span>
              </button>
      ...
      {/* Nuestra Institución */}
      <section className="py-24 max-w-[1600px] mx-auto px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl font-bold mb-8 text-slate-900 dark:text-white">Nuestra Institución</h2>
            <div className="space-y-6 text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              <p>
                La Unidad de Gestión Educativa Local (UGEL) Huacaybamba es un órgano descentralizado del Ministerio de Educación, encargado de administrar y supervisar los servicios educativos en el ámbito de su jurisdicción territorial.
              </p>
              <p>
                Trabajamos de manera coordinada con las instituciones educativas, promoviendo una educación de calidad, inclusiva e intercultural que responda a las necesidades y características de nuestra comunidad educativa.
              </p>
              <p>
                Nuestro compromiso se centra en fortalecer la gestión pedagógica e institucional, brindando acompañamiento técnico y desarrollando capacidades en directivos, docentes y personal administrativo de las instituciones educativas de nuestra jurisdicción.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-900/50">
        <div className="max-w-[1600px] mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-slate-900 dark:text-white">Identidad Institucional</h2>
            <p className="text-slate-500 dark:text-slate-400 text-lg">
              Conoce los pilares fundamentales que definen nuestra labor y compromiso con la educación en Huacaybamba
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="glass-card bg-white dark:bg-slate-800/50 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow border border-slate-200 dark:border-slate-700">
              ...
              <h3 className="text-xl font-bold mb-4 text-slate-900 dark:text-white">Rol de la UGEL</h3>
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                Órgano ejecutor de la política educativa nacional y regional en el ámbito local.
              </p>
            </div>
            <div className="glass-card bg-white dark:bg-slate-800/50 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow border border-slate-200 dark:border-slate-700">
              ...
              <h3 className="text-xl font-bold mb-4 text-slate-900 dark:text-white">Alcance Territorial</h3>
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                Cobertura integral en toda la provincia de Huacaybamba y sus distritos.
              </p>
            </div>
            <div className="glass-card bg-white dark:bg-slate-800/50 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow border border-slate-200 dark:border-slate-700">
              <div className="w-14 h-14 bg-rose-100 dark:bg-rose-900/30 text-rose-600 rounded-xl flex items-center justify-center mb-6">
                <span className="material-symbols-rounded text-3xl">favorite</span>
              </div>
              <h3 className="text-xl font-bold mb-4 text-slate-900 dark:text-white">Compromiso Educativo</h3>
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
            ...
            <div className="glass-card bg-white dark:bg-slate-800/50 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow border border-slate-200 dark:border-slate-700">
              ...
              <h3 className="text-xl font-bold mb-4 text-slate-900 dark:text-white">Articulación</h3>
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                Coordinación efectiva entre instituciones educativas y actores locales.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 max-w-[1600px] mx-auto px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-lg">
            Construimos puentes sólidos con todos los actores del sistema educativo local
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            {
              ...
              description: "Acompañamiento técnico y supervisión pedagógica para el logro de aprendizajes."
            },
            {
              icon: "school",
              title: "Docentes",
              description: "Desarrollo profesional continuo y fortalecimiento de competencias pedagógicas."
            },
            {
              icon: "person_book",
              title: "Estudiantes",
              description: "Garantía de condiciones óptimas para el desarrollo integral y logro de aprendizajes."
            },
            {
              icon: "family_restroom",
              title: "Padres de Familia",
              description: "Participación activa en la formación educativa y desarrollo de sus hijos."
            }
          ].map((item, index) => (
      ...
      {/* Call to Action */}
      <section className="py-24 bg-slate-100 dark:bg-slate-800/30 border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-[1600px] mx-auto px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 dark:text-white">Conoce Más Sobre Nuestra Gestión</h2>
            <p className="text-slate-500 dark:text-slate-400">
              Explora en detalle nuestra estructura organizativa y los servicios que brindamos a la comunidad educativa
            </p>
          </div>
          <div className="flex flex-wrap justify-center gap-6">
            <button className="flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl hover:translate-y-[-2px] transition-all">
              <span className="material-symbols-rounded">account_tree</span> Estructura Organizativa
            </button>
            <button className="flex items-center gap-3 bg-white dark:bg-slate-700 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-600 px-8 py-4 rounded-xl font-semibold shadow-md hover:shadow-lg hover:translate-y-[-2px] transition-all">
              <span className="material-symbols-rounded">grid_view</span> Áreas de Gestión
            </button>
            <button className="flex items-center gap-3 bg-white dark:bg-slate-700 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-600 px-8 py-4 rounded-xl font-semibold shadow-md hover:shadow-lg hover:translate-y-[-2px] transition-all">
              <span className="material-symbols-rounded">folder_open</span> Documentos Oficiales
            </button>
          </div>
        </div>
      </section>
