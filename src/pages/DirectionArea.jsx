      ...
      <main className="pt-32 pb-20 container mx-auto">
        <div className="max-w-7xl mx-auto mb-16">
          ...
          <p className="text-xl text-slate-500 dark:text-slate-400 max-w-2xl font-medium leading-relaxed">
            Liderazgo estratégico y gestión educativa de excelencia para el
            ...
            <div className="space-y-6 overflow-y-auto pr-4">
              <div className="group">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                  Responsable de guiar y coordinar la implementación de
              ...
              <div className="group">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                  Fomenta la innovación educativa a través de la diversificación
                  de currículos.
                </p>
              </div>
              <div className="group">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                  Identifica necesidades de infraestructura y equipamiento.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-8 row-span-3 bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl border border-slate-200 dark:border-slate-700 p-10 rounded-3xl shadow-xl flex flex-col">
            ...
            <div className="grid grid-cols-3 gap-6 flex-grow">
              {teamMembers.map((member) => (
                <div
                  key={member.id}
                  className="p-6 rounded-2xl bg-white/50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 flex flex-col items-center text-center group hover:bg-white dark:hover:bg-slate-800 transition-all duration-300"
                >
                  <div className="relative mb-4">
                    ...
                    <img
                      alt={member.name}
                      className="relative w-24 h-24 rounded-full object-cover border-4 border-white dark:border-slate-700 shadow-md"
                      src={member.photo}
                    />
                  </div>
                  ...
                  <h4 className="font-bold text-slate-900 dark:text-white leading-tight mb-1 text-sm">
                    {member.name}
                  </h4>
            ...
            <div className="mt-6 flex items-center justify-between px-6 py-4 rounded-2xl bg-slate-900 text-white dark:bg-white dark:text-slate-900">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] leading-tight opacity-70 uppercase">
                  Cargos Totales
                </span>
              </div>
            </div>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-transparent to-transparent flex items-end p-8">
              <div className="text-white">
                ...
                <p className="text-sm opacity-80">
                  Gestión enfocada en resultados para Huacaybamba
                </p>
              </div>
            </div>
          </div>
