      ...
      <div className="flex items-end justify-between mb-8 px-2">
        <div>
          ...
          <p className="text-slate-500 mt-2 font-medium">
            Bienvenido de nuevo, tienes 4 actualizaciones importantes hoy.
          </p>
        </div>
          ...
          <GlassCard className="rounded-2xl p-8 h-full bg-white/40 dark:bg-slate-900/60">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex gap-2">
                ...
                <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 text-[10px] font-bold rounded-full uppercase tracking-wider">
                  Filtro: Huacaybamba
                </span>
              </div>
            </div>
            <div className="space-y-4">
              ...
              <div className="group flex flex-col sm:flex-row items-center gap-6 p-5 rounded-2xl bg-white/60 dark:bg-slate-800/60 border border-white/60 dark:border-slate-700 hover:bg-white/80 dark:hover:bg-slate-800 transition-all cursor-pointer">
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <h4 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors">
                    Nueva Vacante: Especialista Pedagógico
                  </h4>
                  <p className="text-sm text-slate-500 dark:text-slate-400 line-clamp-1">
                    Se requiere experiencia en gestión pública y monitoreo
                    curricular. Sede Central UGEL.
                  </p>
                </div>
              ...
              <div className="group flex flex-col sm:flex-row items-center gap-6 p-5 rounded-2xl bg-white/60 dark:bg-slate-800/60 border border-white/60 dark:border-slate-700 hover:bg-white/80 dark:hover:bg-slate-800 transition-all cursor-pointer">
                <div className="relative">
                  <div className="size-16 rounded-2xl overflow-hidden ring-4 ring-white dark:ring-slate-700 shadow-md">
                    <img
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuCY1ddfMdEVn_iSqmRJN5DrSwwUbKMoKkqiogsjna1H929SndTaMFc6uLlkvNjslv6zdgmu5bgAuEpG0YpWmwYtsUCpLzRZ2cP6SzrOtIlU6J7YceNywxvCPxWwAmyKFzziJlZfgwVeMPNCC7hKPJwPKsYKjzUSZzd3ib0cxQkPxuf27fZUQ98R6z3l8DpvU_R21IqJc_CVo2OVnNMrH--BX4VniWj-s9qfvArGzpA13rx-8tcO8YSCbsLav12IoeozFu4TP7RJGPI"
                      alt="Recruiter"
                      className="w-full h-full object-cover"
                    />
                  </div>
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <h4 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors">
                    Convocatoria CAS 004-2024
                  </h4>
                  <p className="text-sm text-slate-500 dark:text-slate-400 line-clamp-1">
                    Puesto disponible para Especialista en Planificación
                    Presupuestaria.
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <GlassCard className="rounded-2xl p-6 h-full flex flex-col bg-white/40 dark:bg-slate-900/60">
            ...
            <div className="space-y-4 flex-1">
              ...
              <div className="p-4 rounded-xl bg-amber-50/50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800 flex gap-4">
                <div className="size-10 bg-amber-100 dark:bg-amber-800 rounded-lg flex items-center justify-center shrink-0">
                  <span className="material-symbols-outlined text-amber-600 dark:text-amber-200">
                    event_busy
                  </span>
                </div>
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    Faltan 48 horas para la fecha límite de entrega vía mesa de
                    partes virtual.
                  </p>
              ...
              <div className="p-4 rounded-xl bg-blue-50/50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 flex gap-4">
                <div className="size-10 bg-blue-100 dark:bg-blue-800 rounded-lg flex items-center justify-center shrink-0">
                  <span className="material-symbols-outlined text-blue-600 dark:text-blue-200">
                    description
                  </span>
                </div>
                <div>
                  ...
                  <h5 className="text-sm font-bold text-slate-900 dark:text-white mb-1">
                    Nueva Resolución Directorial
                  </h5>
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    Se ha publicado la RD-2024-045 sobre lineamientos de
                    evaluación docente.
                  </p>
                  <button className="mt-2 text-xs font-extrabold text-blue-600 dark:text-blue-400 hover:underline">
                    Descargar PDF
                  </button>
                </div>
              </div>
            ...
            <div className="mt-6 p-4 bg-primary/5 dark:bg-primary/10 rounded-2xl border border-primary/10">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">
                Tu contraseña expira en 5 días. Te recomendamos actualizarla hoy
                mismo.
              </p>
              <button className="w-full bg-white dark:bg-slate-800 py-2 rounded-lg text-xs font-bold text-slate-700 dark:text-slate-200 shadow-sm border border-slate-100 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                Cambiar Contraseña
              </button>
            </div>
          </GlassCard>
        ...
        <section className="col-span-12">
          <GlassCard className="rounded-2xl p-6 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden bg-white/40 dark:bg-slate-900/60">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-slate-600 dark:text-slate-300 max-w-2xl font-medium">
                "Tu perfil tiene un 85% de coincidencia con puestos directivos.
                Te sugiero actualizar tu certificado de Gestión Pública para
                alcanzar el 100%."
              </p>
